...
import Logo from '../../images/logo/shop_logo.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#333b62] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <span className="text-2xl font-bold text-white">Shopkart Dashboard</span>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-lightgreen">
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5 text-white">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-lightgreen  ${
                          (pathname === '/' ||
              ...
              {false && <SidebarLinkGroup
                activeCondition={
                  pathname === '/billing' || pathname.includes('billing')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-lightgreen ${
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-lightgreen ${
                    pathname.includes('profile') && 'bg-lightgreen'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {false &&<li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-lightgreen ${
                    pathname.includes('tables') && 'bg-lightgreen'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-lightgreen ${
                    pathname.includes('chart') && 'bg-lightgreen'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-lightgreen ${
