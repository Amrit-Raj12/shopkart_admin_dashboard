    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          ...
          />
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4" onClick={() => navigate('/settings')}>
            <label
              htmlFor="cover"
            ...
            >
              ...
              <span>
              <svg width="18px" height="18px" className='stroke-current' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"> <title /> <g id="Complete"> <g id="edit"> <g> <path d="M20,16v4a2,2,0,0,1-2,2H4a2,2,0,0,1-2-2V6A2,2,0,0,1,4,4H8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /> <polygon fill="none" points="12.5 15.8 22 6.2 17.8 2 8.3 11.5 8 16 12.5 15.8" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /> </g> </g> </g> </g></svg>
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-4.5 w-4.5 cursor-pointer items-center justify-center rounded-full bg-lightgreen text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                {/* <svg
          ...
          <div className="mt-4">
            ...
            <div className='flex justify-center mt-2 gap-2'>
              Role: <p className="font-medium text-lightgreen">{data?.isAdmin ? "Admin": "user"}</p>
            </div>
